...
//       <Card className="w-full  shadow-lg border border-gray-100 rounded-2xl">
//         <CardContent className="">
//           {/* Logo */}
//           <div className="flex justify-center mb-4">
//             <Image src="/Logo-new.webp" alt="Logo" width={130} height={130} />
//           </div>
...
//                 type="submit"
//                 text="Login"
//                 className="font-bold text-md w-full bg-[#02a282] hover:bg-[#019376] cursor-pointer"
//               />
//             </form>
...
//                 className="flex items-center justify-center gap-3 border rounded-lg py-2 hover:bg-gray-100 transition"
//               >
...
//                 className="text-[#02a282] hover:underline"
//               >
//                 Forgot password?
//               </Link>
//             </div>
